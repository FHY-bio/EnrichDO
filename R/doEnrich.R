...
#'@return a data frame of enrichment result
#'@importFrom magrittr `%>%`
...
#'doEnrich(interestGenes=demo.data,penalize = FALSE)
#'
#'#Statistical models and P-value correction can be set
#'doEnrich(demo.data,test="hypergeomTest",method="holm")
#'
...
#'doEnrich(demo.data,minGsize=5,maxGsize=500)
#'
...
#主要函数
doEnrich <- function(interestGenes,test="hypergeomTest",method="BH",m=1,maxGsize=5000,minGsize=5,traditional=FALSE,delta=0.01,result_do=NULL,penalize=T) {
